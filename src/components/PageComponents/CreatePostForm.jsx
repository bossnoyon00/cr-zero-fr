  ...
  return (
    <div className="w-[75vw] min-w-[800px] bg-white p-5 ">
      ...
      <div className="flex flex-col items-center justify-center ">
        <h2 className="text-2xl font-medium my-[21px] ">Enlist a Program</h2>
        <p className="text-[#000000d9] w-[600px] text-center mb-3  ">
          You may enlist multiple programs if you have different types of offers
          or items within your business. But beware that intentionally abusing
          our service will lead to an IP ban. Please follow our terms and
          conditions.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col justify-center">
        ...
        <div className="w-full flex flex-col gap-1 mb-5">
          <label htmlFor="category" className="flex items-center gap-1 text-lg">
            <FaAsterisk className="text-[8px] text-red-500" />
            Category
          </label>
        ...
        >
          <div className="w-full flex flex-col gap-1 mb-5 relative">
            ...
            />
            <span className="absolute right-[5px] top-10 select-none ">$</span>
          </div>
        ...
        <div className={`w-full flex flex-col gap-1 ${!typeCash && "mb-5"}`}>
        ...
        >
          {selectedPlan !== null &&
            ...
            moment(new Date().setMonth(new Date().getMonth() + 1)).format(
              ...
              ? "Enlist for $9.33"
              : selectedPlan ===
                moment(new Date().setMonth(new Date().getMonth() + 6)).format(
                  "MMMM DD, YYYY"
                )
              ? "Enlist for $16.66"
              : selectedPlan ===
