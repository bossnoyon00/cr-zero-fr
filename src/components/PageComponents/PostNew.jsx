  ...
  return (
    <>
      ...
      <div className="flex items-start mobile:flex-col">
        ...
        <div
          className="bg-white border border-black rounded-tr-md mobile:rounded-t-md rounded-bl-md shadow-[0_4px_38px_0_rgba(0,0,0,0.1)] w-[100%] cursor-pointer min-h-[200px] grid grid-cols-[1fr_150px] mobile:grid-cols-1 grid-rows-1"
          onClick={showModal2}
        >
            ...
            <div className="right-desc flex flex-col gap-2">
              ...
              <div className="category-container flex items-center gap-2">
                {data?.category.map((item, index) => (
                  <button
                    key={index}
                    className="bg-[#2d93e8] text-white rounded-[4px] px-2 flex items-center justify-center"
                  >
                    {item}
                  </button>
                ))}
              ...
              <p className="para-2 mobile:!text-xs">
                {data.comission?.length === 2 && (
                  <div className="flex gap-1">
                    <span className="mobile:!text-xs">{`$${data?.comissionValue}`}</span>{" "}
                    <span>&#47;</span>
                    <img
                      src={Reward}
                      alt="reward"
                ...
                {data.comission?.length < 2 &&
                  data.comission?.[0] === "reward" && (
                    <img
                      src={Reward}
                      alt="reward"
                      className="w-[25px] mobile:w-[20px]"
                    />
                  )}
              </p>
            </div>
        ...
        <div className="hidden mobile:flex self-end">
          {tabName !== "expired" && (
            <div className="flex">
              ...
              <div
                className={`border-b border-black p-[10px] flex items-center justify-center gap-2 bg-white cursor-pointer ${
                  tabName === "reported" && "border-l rounded-bl-md"
                }`}
                onClick={showModal2}
                style={{ cursor: "pointer" }}
              >
                <VscComment className="w-5 h-5" />
                <Paragraph className="count !mb-0">
          ...
          <div className="flex">
            <div
              className={`report-post flex items-center justify-center p-[10px] bg-white border border-black border-t-transparent rounded-br-md ${
                tabName === "my" && "rounded-br-none"
              } ${tabName === "expired" && "rounded-br-none rounded-bl-md"} `}
              onClick={() => {
            ...
            >
              {tabName === "reported" ? (
                ...
                >
                  <BsFillFlagFill className="fill-[#ff9c6e] cursor-pointer w-[20px] h-[20px]" />
                </Badge>
              ) : (
        ...
        <div className="right mobile:hidden self-end shadow-[8px_0_15px_-3px_rgba(0,0,0,0.1)]">
          ...
          >
            {tabName === "reported" ? (
              ...
              >
                <BsFillFlagFill className="fill-[#ff9c6e] cursor-pointer w-[30px] h-[30px]" />
              </Badge>
            ) : (
